...
sm.sendNext("So, you're the one Mai was talking about? #h #... I guess you do have some potential. You want to become a Thief? Do you know what Thieves are all about?")
...
if sm.sendAskAccept("Now, will you join us on the path of Thieves? If you decide to do so, I will bring you to the #bsecret Thieves' Hideout in Kerning City#k using my power as the Job Instructor... You should feel honored. #rBut if you prefer a different job, I will help you find the other paths#k."):
    sm.warp(103000003)
