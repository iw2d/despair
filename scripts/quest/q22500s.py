...
sm.setSpeakerID(MIR)
sm.sendSay("Yuuup! Heeeey...! What's with the face? You.. dont want to be my master?")
sm.setPlayerAsSpeaker()
...
sm.setPlayerAsSpeaker()
sm.sendSay("#b...(You stare at him skeptically. He looks like a lizard. A puny little one, at that.)")
sm.setSpeakerID(MIR)
if sm.sendAskAccept("Why are you looking at me like that?! Just watch! See what I can do with my power. Ready?"):
    sm.sendNext("Attack the #r#o" + repr(PIG) + "##k! It's time to awaken my true power and prove myself as a dragon! Chaaaarge!")
