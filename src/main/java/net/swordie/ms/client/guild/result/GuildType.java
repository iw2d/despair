...
public enum GuildType {
    ...
    Res_JoinGuild_AlreadyFull(64),
    Res_JoinGuild_MaxRequests(65),
    Res_JoinGuild_CannotFindCharacter(66),
    Res_JoinGuild_CannotFindRequester(67),
    Res_Unk68(68),
